...
// メインカテゴリ：初心者にも分かりやすい名称＋説明
// id は AI への入力用（短い）、label は表示用、desc はサブ説明
export const MAIN_CATEGORIES = [
  { id: 'エンタメ・バラエティ', label: 'エンタメ', desc: '笑える・面白い系' },
  { id: 'ゲーム実況', label: 'ゲーム実況', desc: 'プレイ動画・攻略' },
  { id: '教育・解説', label: '学び・解説', desc: '勉強・知識系' },
  { id: 'ビジネス・マネー', label: 'お金・ビジネス', desc: '投資・副業・経済など' },
  { id: '美容・ファッション', label: '美容・ファッション', desc: 'メイク・コーデ' },
  { id: '料理・グルメ', label: '料理・グルメ', desc: 'レシピ・食レポ' },
  { id: '旅行・Vlog', label: '旅行・日常Vlog', desc: '旅・暮らしの記録' },
  { id: '健康・フィットネス', label: '健康・筋トレ', desc: 'ダイエット・運動' },
  { id: 'テクノロジー・AI', label: 'AI・パソコン', desc: 'ガジェット・ツール' },
  { id: '音楽・アーティスト', label: '音楽', desc: '歌ってみた・演奏' },
  { id: 'スポーツ', label: 'スポーツ', desc: '試合・技術解説' },
  { id: 'アニメ・マンガ・漫画', label: 'アニメ・マンガ', desc: '考察・解説' },
  { id: '恋愛・人間関係', label: '恋愛・人間関係', desc: 'モテ・コミュ術' },
  { id: 'その他', label: 'その他', desc: 'どれにも当てはまらない' },
];

// サブカテゴリ：具体例＋括弧で範囲を明示
export const SUB_CATEGORIES = [
  { id: 'ビジネス・起業', label: 'ビジネス・起業', desc: '経営・売上アップ' },
  { id: '副業・フリーランス', label: '副業・在宅ワーク', desc: '月数万円〜稼ぐ' },
  { id: '投資・資産形成', label: '投資・資産運用', desc: '株・NISA・iDeCo' },
  { id: '金融・経済', label: '金融・経済ニュース', desc: '市況・経済解説' },
  { id: 'AI・テクノロジー', label: 'AI活用', desc: 'ChatGPT・Claude等' },
  { id: 'キャリア・スキルアップ', label: '転職・キャリアアップ', desc: '昇給・スキル' },
  { id: '美容・ライフスタイル', label: '暮らし・ライフスタイル', desc: '日常を豊かに' },
  { id: '健康・メンタル', label: '健康・メンタルケア', desc: '心と体のケア' },
  { id: '恋愛・人間関係', label: '恋愛・コミュニケーション', desc: '人付き合い' },
  { id: 'エンタメ・雑談', label: '雑談・モチベ系', desc: '気軽な話題' },
  { id: 'その他', label: 'その他', desc: 'どれにも当てはまらない' },
];
