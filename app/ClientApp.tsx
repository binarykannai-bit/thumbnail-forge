      ...
      <div style={styles.thumbCard}>
        ...
        <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 6, borderTop: `1px solid ${C.border}` }}>
          ...
          <div style={{ ...styles.patternTextWrap, padding: 10 }}>
            <div style={{ ...styles.thumbMain, fontSize: 18 }}>{renderWithMarker(t.main, t.marker)}</div>
            {t.sub && <div style={{ ...styles.thumbSub, fontSize: 13 }}>{renderWithMarker(t.sub, t.marker)}</div>}
            {t.marker && (
