              ...
              thumbnailText: {
                ...
                properties: {
                  badge: {
                    type: 'string',
                    description:
                      '吹き出し型の煽り文句。2〜12文字。例「速報」「最新」「9割が知らない」「※必見」「警告」。不要な場合のみ空文字。',
                  },
                  headline: {
                    type: 'string',
                    description:
                      '上段テキスト。テーマ・カテゴリ・対象者を示す短いフレーズ。2〜14文字。例「2026年版」「NISA投資家へ」「在宅副業」「40代女性向け」。不要な場合のみ空文字。',
                  },
                  mainCopy: {
                    type: 'string',
                    description:
                      '最大文字のメインコピー。8〜20文字。パワーワード6カテゴリ（希少性/損失回避/権威性/数字/意外性/緊急性）のいずれかを含む。**助詞を抜かず自然な日本語で完結させる**。例「99%が知らない投資の真実」「月5万円が30分で稼げる方法」「やってはいけない3つのNG」「実は逆効果だった習慣」。必須。',
                  },
                  subCopy: {
                    type: 'string',
                    description:
                      '下段テキスト。メリット・結果・補足。8〜24文字。**助詞を抜かず自然な日本語で完結させる**。例「初心者でも1ヶ月で月3万円達成」「主婦の私でも在宅で稼げました」「2026年最新のやり方を完全解説」。不要な場合のみ空文字。',
                  },
                  marker: {
                    type: 'string',
                    description:
                      '黄色マーカー強調語。1〜6文字。badge/headline/mainCopy/subCopy のいずれかに既に含まれている単語であること。数字・金額・キーワードが最適。',
                  },
                },
